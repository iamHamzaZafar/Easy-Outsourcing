...
import { Truck, Route, MapPin, Clock, BarChart3, Shield, CheckCircle, Send } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Advanced algorithms to find the most efficient routes and reduce fuel costs',
      features: ['Real-time traffic analysis', 'Multi-stop optimization', 'Fuel cost reduction', 'Time-based routing']
    },
    {
      icon: MapPin,
      title: 'Load Management',
      description: 'Comprehensive load planning and tracking for maximum efficiency',
      features: ['Load matching', 'Capacity optimization', 'Delivery scheduling', 'Load tracking']
    },
    {
      icon: BarChart3,
      title: 'Fleet Analytics',
      description: 'Detailed reporting and analytics for fleet performance optimization',
      features: ['Performance metrics', 'Cost analysis', 'Driver scorecards', 'Maintenance tracking']
    }
  ];

  const benefits = [
    'Reduce empty miles by up to 30%',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive truck dispatching services to optimize your fleet operations
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-white/80">Trucks Managed</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our professional dispatching services help transportation companies optimize 
                routes, reduce costs, and improve overall operational efficiency.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Get started with professional truck dispatching services
            </p>
          </div>
              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">
                    Your inquiry has been submitted. Our dispatching specialist will contact you within 24 hours.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Label htmlFor="message">Fleet Requirements *</Label>
                    <Textarea
                      id="message"
                      name="message"
                      ...
                      rows={4}
                      className="mt-1"
                      placeholder="Tell us about your fleet size, routes, and dispatching needs..."
                    />
                  </div>
